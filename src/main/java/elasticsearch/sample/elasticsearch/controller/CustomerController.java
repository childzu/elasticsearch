package elasticsearch.sample.elasticsearch.controller;

import elasticsearch.sample.elasticsearch.data.Customer;
import elasticsearch.sample.elasticsearch.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<?> search(@RequestParam String q) {
        SearchHits<Customer> customers = customerService.searchCustomer(q);
        return ResponseEntity.ok(customers);
    }
}
